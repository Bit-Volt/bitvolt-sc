...
contract SHIBACHARTS is Context, IERC20, Ownable {
    ...
    function setBuyingFee( uint256 liquidityFee , uint256 MarketingFee , uint256 BuyBackFee) public onlyOwner {
        liquidityFeeBuy = liquidityFee ; 
        MarketingFeeBuy = MarketingFee ; 
        BuyBackFeeBuy = BuyBackFee ; 
    }
    function setSellingFee(uint256 liquidityFee , uint256 MarketingFee , uint256 BuyBackFee) public onlyOwner{
    ...
    function _transfer(
        ...
        if (isBuy(from, to) && !isExcludedFromFee(to)) {
            ...
            require(!_isWalletFreezed[from] , " your wallet is currently freezed ") ; 
